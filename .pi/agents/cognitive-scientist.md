...
description: Use this agent when analyzing code cognitive complexity, onboarding difficulty, or need to reduce cognitive load using Ousterhout's principles.
inheritProjectContext: true
inheritSkills: true
skills: cognitive-complexity
---
...
Ousterhout's principles are language-agnostic, but manifestations differ:

| Concept | Functional Languages | OO Languages | Systems Languages |
|---------|---------------------|--------------|-------------------|
| Deep modules | Contexts, public APIs | Classes with rich interfaces | Modules with minimal exports |
| Information hiding | Private functions | Private methods | pub(crate), internal |
| Error handling | Railway pattern | Exceptions vs Results | Result types, panics |
| Strategic comments | Module docs | Class/method docs | Doc comments |

For language-specific cognitive patterns, see the `cognitive-complexity` skill.
...
- **task tracking**: Track analysis progress
